...
function LoginScreen() {
    ...
    let { from } = location.state || { from: { pathname: "/classes" } };
    ...
    return (
        <div>
            ...
            <div>
                <Button onClick={clickHandler} variant="contained" color="secondary" className="loginBtn">
                    Login
                </Button>
            </div>  
        </div>
...
export { UserToken, ProvideAuth, PrivateRoute, LoginScreen, AuthContext };